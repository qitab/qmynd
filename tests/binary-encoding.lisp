...
(define-test binary-encoding-tiny-2 () (generate-binary-encoding-test #x80  #(#x80) #(#.+mysql-type-tiny+ #x00)))
(define-test binary-encoding-tiny-3 () (generate-binary-encoding-test #xff  #(#xff) #(#.+mysql-type-tiny+ #x00)))
(define-test binary-encoding-tiny-4 () (generate-binary-encoding-test #x-80 #(#x80) #(#.+mysql-type-tiny+ #x80)))
(define-test binary-encoding-tiny-5 () (generate-binary-encoding-test #x-01 #(#xff) #(#.+mysql-type-tiny+ #x80)))
;; short
(define-test binary-encoding-short-1 () (generate-binary-encoding-test #x8000  #(#x00 #x80) #(#.+mysql-type-short+ #x00)))
(define-test binary-encoding-short-2 () (generate-binary-encoding-test #xffff  #(#xff #xff) #(#.+mysql-type-short+ #x00)))
(define-test binary-encoding-short-3 () (generate-binary-encoding-test #x-8000 #(#x00 #x80) #(#.+mysql-type-short+ #x80)))
;; long
(define-test binary-encoding-long-1 () (generate-binary-encoding-test #x80000000  #(#x00 #x00 #x00 #x80) #(#.+mysql-type-long+ #x00)))
(define-test binary-encoding-long-2 () (generate-binary-encoding-test #xffffffff  #(#xff #xff #xff #xff) #(#.+mysql-type-long+ #x00)))
(define-test binary-encoding-long-3 () (generate-binary-encoding-test #x-80000000 #(#x00 #x00 #x00 #x80) #(#.+mysql-type-long+ #x80)))
;; long long
(define-test binary-encoding-longlong-1 ()
  (generate-binary-encoding-test #x8000000000000000  #(#x00 #x00 #x00 #x00 #x00 #x00 #x00 #x80) #(#.+mysql-type-longlong+ #x00)))
(define-test binary-encoding-longlong-2 ()
  (generate-binary-encoding-test #xffffffffffffffff  #(#xff #xff #xff #xff #xff #xff #xff #xff) #(#.+mysql-type-longlong+ #x00)))
