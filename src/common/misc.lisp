...
(defun mysql-cs-coll-to-character-encoding (cs-coll)
  ...
  (ecase cs-coll
    ...
    (#. +mysql-cs-coll-koi8r-general-ci+            :koi8-r)
    ...
    (#. +mysql-cs-coll-hebrew-general-ci+           :iso-8859-8)
    ...
    (#. +mysql-cs-coll-koi8u-general-ci+            :koi8-u)
    (#. +mysql-cs-coll-cp1251-ukrainian-ci+         :cp1251)
    (#. +mysql-cs-coll-gb2312-chinese-ci+           :gbk) ; gb2312 is a subset of gbk
    (#. +mysql-cs-coll-greek-general-ci+            :iso-8859-7)
    ...
    (#. +mysql-cs-coll-latin1-german2-ci+           :iso-8859-1)
    (#. +mysql-cs-coll-armscii8-general-ci+         :iso-8859-1)
    (#. +mysql-cs-coll-utf8mb3-general-ci+          :utf-8)
    ;; (#. +mysql-cs-coll-cp1250-general-ci+           :unknown)
    ...
    (#. +mysql-cs-coll-greek-binary+                :iso-8859-7)
    (#. +mysql-cs-coll-hebrew-binary+               :iso-8859-8)
    (#. +mysql-cs-coll-hp8-binary+                  :us-ascii)
    ;; (#. +mysql-cs-coll-keybcs2-binary+              :unknown)
    (#. +mysql-cs-coll-koi8r-binary+                :koi8-r)
    (#. +mysql-cs-coll-koi8u-binary+                :koi8-u)
    (#. +mysql-cs-coll-utf8mb3-tolower-ci+          :utf-8)
    ...
    (#. +mysql-cs-coll-utf8mb3-binary+              :utf-8)
    ;; (#. +mysql-cs-coll-big5-binary+                 :unknown)
    ;; (#. +mysql-cs-coll-euckr-binary+                :unknown)
    (#. +mysql-cs-coll-gb2312-binary+               :gbk) ; gb2312 is a subset of gbk
    ...
    (#. +mysql-cs-coll-utf8mb3-unicode-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb3-icelandic-ci+        :utf-8)
    (#. +mysql-cs-coll-utf8mb3-latvian-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb3-romanian-ci+         :utf-8)
    (#. +mysql-cs-coll-utf8mb3-slovenian-ci+        :utf-8)
    (#. +mysql-cs-coll-utf8mb3-polish-ci+           :utf-8)
    (#. +mysql-cs-coll-utf8mb3-estonian-ci+         :utf-8)
    (#. +mysql-cs-coll-utf8mb3-spanish-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb3-swedish-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb3-turkish-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb3-czech-ci+            :utf-8)
    (#. +mysql-cs-coll-utf8mb3-danish-ci+           :utf-8)
    (#. +mysql-cs-coll-utf8mb3-lithuanian-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb3-slovak-ci+           :utf-8)
    (#. +mysql-cs-coll-utf8mb3-spanish2-ci+         :utf-8)
    (#. +mysql-cs-coll-utf8mb3-roman-ci+            :utf-8)
    (#. +mysql-cs-coll-utf8mb3-persian-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb3-esperanto-ci+        :utf-8)
    (#. +mysql-cs-coll-utf8mb3-hungarian-ci+        :utf-8)
    (#. +mysql-cs-coll-utf8mb3-sinhala-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb3-german2-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb3-croatian-ci+         :utf-8)
    (#. +mysql-cs-coll-utf8mb3-unicode-520-ci+      :utf-8)
    (#. +mysql-cs-coll-utf8mb3-vietnamese-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb3-general-mysql500-ci+ :utf-8)
    (#. +mysql-cs-coll-utf8mb4-unicode-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-icelandic-ci+        :utf-8)
    (#. +mysql-cs-coll-utf8mb4-latvian-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-romanian-ci+         :utf-8)
    (#. +mysql-cs-coll-utf8mb4-slovenian-ci+        :utf-8)
    (#. +mysql-cs-coll-utf8mb4-polish-ci+           :utf-8)
    (#. +mysql-cs-coll-utf8mb4-estonian-ci+         :utf-8)
    (#. +mysql-cs-coll-utf8mb4-spanish-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-swedish-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-turkish-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-czech-ci+            :utf-8)
    (#. +mysql-cs-coll-utf8mb4-danish-ci+           :utf-8)
    (#. +mysql-cs-coll-utf8mb4-lithuanian-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-slovak-ci+           :utf-8)
    (#. +mysql-cs-coll-utf8mb4-spanish2-ci+         :utf-8)
    (#. +mysql-cs-coll-utf8mb4-roman-ci+            :utf-8)
    (#. +mysql-cs-coll-utf8mb4-persian-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-esperanto-ci+        :utf-8)
    (#. +mysql-cs-coll-utf8mb4-hungarian-ci+        :utf-8)
    (#. +mysql-cs-coll-utf8mb4-sinhala-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-german2-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-croatian-ci+         :utf-8)
    (#. +mysql-cs-coll-utf8mb4-unicode-520-ci+      :utf-8)
    (#. +mysql-cs-coll-utf8mb4-vietnamese-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb3-general-cs+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-0900-ai-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-de-pb-0900-ai-ci+    :utf-8)
    (#. +mysql-cs-coll-utf8mb4-is-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-lv-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-ro-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-sl-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-pl-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-et-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-es-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-sv-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-tr-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-cs-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-da-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-lt-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-sk-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-es-trad-0900-ai-ci+  :utf-8)
    (#. +mysql-cs-coll-utf8mb4-la-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-eo-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-hu-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-hr-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-vi-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-0900-as-cs+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-de-pb-0900-as-cs+    :utf-8)
    (#. +mysql-cs-coll-utf8mb4-is-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-lv-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-ro-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-sl-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-pl-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-et-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-es-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-sv-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-tr-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-cs-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-da-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-lt-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-sk-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-es-trad-0900-as-cs+  :utf-8)
    (#. +mysql-cs-coll-utf8mb4-la-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-eo-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-hu-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-hr-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-vi-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-ja-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-ja-0900-as-cs-ks+    :utf-8)
    (#. +mysql-cs-coll-utf8mb4-0900-as-ci+          :utf-8)
    (#. +mysql-cs-coll-utf8mb4-ru-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-ru-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-zh-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-0900-bin+            :utf-8)
    (#. +mysql-cs-coll-utf8mb4-nb-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-nb-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-nn-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-nn-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-sr-latn-0900-ai-ci+  :utf-8)
    (#. +mysql-cs-coll-utf8mb4-sr-latn-0900-as-cs+  :utf-8)
    (#. +mysql-cs-coll-utf8mb4-bs-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-bs-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-bg-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-bg-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-gl-0900-ai-ci+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-gl-0900-as-cs+       :utf-8)
    (#. +mysql-cs-coll-utf8mb4-mn-cyrl-0900-ai-ci+  :utf-8)
    (#. +mysql-cs-coll-utf8mb4-mn-cyrl-0900-as-cs+  :utf-8)))
